"""
Data Science Agent Routes - Integrates with FastAPI
Provides endpoints for iterative data science analysis
"""
...
class DataScienceQuery(BaseModel):
    """Request model for data science analysis"""
...
async def analyze_data(
    request: DataScienceQuery,
    current_user: dict = Depends(get_current_user)
) -> StreamingResponse:
    """
    Execute iterative data science analysis.
    Returns streaming responses with code generation, execution, and results.
    """
    
    async def event_generator():
        try:
            agent = DataScienceAgent(
                client_id=current_user.get("client_id", "default"),
                db=None  # Pass your DB instance if needed
            )
            
            async for event in agent.execute_analysis(
...
async def analyze_with_upload(
    ...
    """
    Upload a dataset and run data science analysis.
    """
